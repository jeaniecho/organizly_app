...
NoteVM noteMock0 = NoteVM(
    id: 0,
    pinned: false,
    dateTime: DateTime.parse('20231002'),
    text:
...
NoteVM noteMock1 = NoteVM(
    id: 1,
    pinned: false,
    dateTime: DateTime.parse('20230928'),
    text: 'This is note mock 1');
NoteVM noteMock2 = NoteVM(
    id: 2,
    pinned: true,
    dateTime: DateTime.parse('20230930'),
    text:
        'This is pinned note mock 2\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Sed id ante pulvinar, accumsan sem et, placerat nibh. Vestibulum malesuada vel arcu placerat sollicitudin. Suspendisse eu velit ac nibh auctor faucibus.');
NoteVM noteMock3 = NoteVM(
    id: 3,
    pinned: false,
    dateTime: DateTime.parse('20230920'),
    text:
...
NoteVM noteMock4 = NoteVM(
    id: 4,
    pinned: true,
    dateTime: DateTime.parse('20231001'),
    text: 'This is pinned note mock 4');
